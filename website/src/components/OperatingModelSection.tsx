    ...
    <section className="grid grid-cols-4 gap-4 md:grid-cols-6 lg:grid-cols-12" aria-label="Operating model and faculty note">
      ...
      <div className="col-span-4 md:col-span-6 lg:col-span-4">
        <div className="pop-panel panel-surface border-[var(--border-w)] border-[var(--border-color)] p-6">
          ...
          <blockquote className="mt-6 text-3xl font-black leading-tight tracking-tight">“{facultyNote.quote}”</blockquote>

          <div className="mt-6">
            <div className="text-sm font-black uppercase tracking-wider text-[var(--accent-color)]">{facultyNote.name}</div>
